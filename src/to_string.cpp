...
{
	std::string surfaceFormatString = vulkanToString(surfaceFormat.format) + ", ";
...
const std::string vulkanToString(VkSampleCountFlagBits flags)
{
	std::string result{""};
	bool        append = false;
...
const std::string vulkanToString(VkImageType type)
{
	switch (type)
	{
